...
public class Utils {
	...
	public void Welcomepage() throws Exception {
		...
		WebElement Error = driver.findElement(By.xpath("//h1[@class='welcome-banner__message']"));
	...
	public void AccountHeader() {
		...
		String name = driver.findElement(By.xpath("//span[contains(text(),'Hi')]")).getText();
		test.log(LogStatus.INFO, "Finding Error Message");
	...
	public void elementclickable(WebElement element) throws Exception {
		...
		test = extent.startTest("Element Clickable", "Checking");
	...
	public boolean alerthandling() {
		...
		test = extent.startTest("AlertHandling", "Checking");
	...
	public void sikulisignin() throws Exception {
		...
		test = extent.startTest("SignIn Check", "Checking");
...
public void hardrefresh() throws Exception {
	...
	test = extent.startTest("Hard refresh", "refresh the browser");
